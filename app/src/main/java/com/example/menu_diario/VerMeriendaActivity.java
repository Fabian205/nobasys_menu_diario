...
public class VerMeriendaActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ver_merienda);
        txtBuscar = findViewById(R.id.txtBuscar);
        listaMenues = findViewById(R.id.listaMenues);
        listaMenues.setLayoutManager(new LinearLayoutManager(this));

        DbMenuDiario dbMenuDiario = new DbMenuDiario(VerMeriendaActivity.this);

        listaArrayMenues = new ArrayList<>();

        adapter = new ListaMenuAdapter(dbMenuDiario.mostrarMenuesMer());
